# SellerAI Frontend - ReactBits Background Component

Bu dosyaya ReactBits'ten seçtiğin background component'inin dokümantasyonunu ve kodlarını yapıştır.
...
```bash
bun x --bun shadcn@latest add @react-bits/LightPillar-JS-CSS
```

...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Loader2, X, Info } from 'lucide-react';
            ...
            <AnimatePresence>
                {googleMessage && (
                    ...
                    >
                        ...
                        <span className="text-white text-sm font-medium">Google ile giriş yakında aktif olacak!</span>

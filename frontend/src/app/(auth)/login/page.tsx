...
export default function LoginPage() {
    ...
    /*
        ...
        */
    const googleLogin = () => {
        alert("Google ile giriş şu an bakımda. Lütfen e-posta ile giriş yapın.");
    };
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-8">
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.99 }}
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 rounded-xl text-gray-700 font-medium text-sm transition-all shadow-lg shadow-white/10 disabled:opacity-70 disabled:cursor-not-allowed mb-4"
                        >
                            {isGoogleLoading ? (
                                <>

...
const plans = [
    ...
    },
    {
        ...
        price: '399',
        period: '/ay',
        credits: '150 Kredi/Ay',
        icon: Zap,
        popular: false,
        features: [
            'Aylık 150 AI üretim kredisi',
            'Tüm pazaryerleri',
            'SEO optimizasyonu',
            'Toplu işlemler',
            'Öncelikli destek',
        ],
        buttonText: 'Starter Seç',
        variant: 'basic'
    },
    {
        name: 'Pro',
        ...
        icon: Crown, // Using Crown for Pro now
        popular: true,
        features: [
            'Aylık 500 AI üretim kredisi',
            'Tüm özellikler aktif',
            'Gelişmiş analitik',
            'En hızlı işlem süresi',
            'Premium destek',
        ],
    ...
    return (
        <motion.div
            ...
            className={cn(
                ...
                isPro
                    ? "bg-white/[0.03] border-indigo-500/50 shadow-2xl shadow-indigo-500/10 z-10 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(99,102,241,0.3)]"
        ...
        >
            ...
            <Link
                href="/register"
                className={cn(
                    "block w-full py-4 rounded-xl text-center font-medium transition-all duration-200 relative overflow-hidden mt-auto",
                    isPro
                        ? "bg-white text-black hover:bg-indigo-50 shadow-lg shadow-white/10"
